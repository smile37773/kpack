...
{
    /// <summary>
    /// KpackBuildV1alpha1Build
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1Build :  IEquatable<KpackBuildV1alpha1Build>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1Build" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KpackBuildV1alpha1Build() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1Build" /> class.
        /// </summary>
        ...
        public KpackBuildV1alpha1Build(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), KpackBuildV1alpha1BuildSpec spec = default(KpackBuildV1alpha1BuildSpec), KpackBuildV1alpha1BuildStatus status = default(KpackBuildV1alpha1BuildStatus))
        {
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new InvalidDataException("spec is a required property for KpackBuildV1alpha1Build and cannot be null");
            }
            else
            {
                this.Spec = spec;
        ...
        public KpackBuildV1alpha1BuildSpec Spec { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public KpackBuildV1alpha1BuildStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1Build {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1Build);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1Build instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1Build to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1Build input)
        {
            if (input == null)
                return false;
