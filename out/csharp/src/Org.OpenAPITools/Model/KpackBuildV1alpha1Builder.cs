...
{
    /// <summary>
    /// KpackBuildV1alpha1Builder
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1Builder :  IEquatable<KpackBuildV1alpha1Builder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1Builder" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KpackBuildV1alpha1Builder() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1Builder" /> class.
        /// </summary>
        ...
        public KpackBuildV1alpha1Builder(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), KpackBuildV1alpha1NamespacedBuilderSpec spec = default(KpackBuildV1alpha1NamespacedBuilderSpec), KpackBuildV1alpha1BuilderStatus status = default(KpackBuildV1alpha1BuilderStatus))
        {
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new InvalidDataException("spec is a required property for KpackBuildV1alpha1Builder and cannot be null");
            }
            else
            {
                this.Spec = spec;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for KpackBuildV1alpha1Builder and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        public KpackBuildV1alpha1NamespacedBuilderSpec Spec { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1Builder {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1Builder);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1Builder instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1Builder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1Builder input)
        {
            if (input == null)
                return false;
