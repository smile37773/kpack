...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1BuilderList :  IEquatable<KpackBuildV1alpha1BuilderList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1BuilderList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KpackBuildV1alpha1BuilderList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1BuilderList" /> class.
        /// </summary>
        ...
        public List<KpackBuildV1alpha1Builder> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1BuilderList {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1BuilderList);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1BuilderList instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1BuilderList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1BuilderList input)
        {
            if (input == null)
                return false;
