...
{
    /// <summary>
    /// KpackBuildV1alpha1SourceResolver
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1SourceResolver :  IEquatable<KpackBuildV1alpha1SourceResolver>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1SourceResolver" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KpackBuildV1alpha1SourceResolver() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1SourceResolver" /> class.
        /// </summary>
        ...
        public KpackBuildV1alpha1SourceResolver(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), KpackBuildV1alpha1SourceResolverSpec spec = default(KpackBuildV1alpha1SourceResolverSpec), KpackBuildV1alpha1SourceResolverStatus status = default(KpackBuildV1alpha1SourceResolverStatus))
        {
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new InvalidDataException("spec is a required property for KpackBuildV1alpha1SourceResolver and cannot be null");
            }
            else
            {
                this.Spec = spec;
        ...
        public KpackBuildV1alpha1SourceResolverSpec Spec { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name="status", EmitDefaultValue=false)]
        public KpackBuildV1alpha1SourceResolverStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1SourceResolver {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1SourceResolver);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1SourceResolver instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1SourceResolver to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1SourceResolver input)
        {
            if (input == null)
                return false;
