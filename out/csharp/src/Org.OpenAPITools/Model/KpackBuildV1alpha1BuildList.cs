...
{
    /// <summary>
    /// KpackBuildV1alpha1BuildList
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1BuildList :  IEquatable<KpackBuildV1alpha1BuildList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1BuildList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KpackBuildV1alpha1BuildList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1BuildList" /> class.
        /// </summary>
        ...
        public KpackBuildV1alpha1BuildList(string apiVersion = default(string), List<KpackBuildV1alpha1Build> items = default(List<KpackBuildV1alpha1Build>), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ListMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ListMeta))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for KpackBuildV1alpha1BuildList and cannot be null");
            }
            else
            {
                this.Items = items;
            ...
            if (metadata == null)
            {
                throw new InvalidDataException("metadata is a required property for KpackBuildV1alpha1BuildList and cannot be null");
            }
            else
            {
        ...
        public List<KpackBuildV1alpha1Build> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1BuildList {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1BuildList);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1BuildList instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1BuildList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1BuildList input)
        {
            if (input == null)
                return false;
