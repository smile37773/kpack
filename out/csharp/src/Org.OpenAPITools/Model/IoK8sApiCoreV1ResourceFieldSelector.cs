...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IoK8sApiCoreV1ResourceFieldSelector :  IEquatable<IoK8sApiCoreV1ResourceFieldSelector>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as IoK8sApiCoreV1ResourceFieldSelector);
        }

        /// <summary>
        /// Returns true if IoK8sApiCoreV1ResourceFieldSelector instances are equal
        /// </summary>
        /// <param name="input">Instance of IoK8sApiCoreV1ResourceFieldSelector to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IoK8sApiCoreV1ResourceFieldSelector input)
        {
            if (input == null)
                return false;
