...
{
    /// <summary>
    /// KpackBuildV1alpha1ImageBuild
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1ImageBuild :  IEquatable<KpackBuildV1alpha1ImageBuild>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1ImageBuild {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1ImageBuild);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1ImageBuild instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1ImageBuild to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1ImageBuild input)
        {
            if (input == null)
                return false;
