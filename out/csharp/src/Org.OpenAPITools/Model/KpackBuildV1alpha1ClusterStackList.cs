...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KpackBuildV1alpha1ClusterStackList :  IEquatable<KpackBuildV1alpha1ClusterStackList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1ClusterStackList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KpackBuildV1alpha1ClusterStackList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KpackBuildV1alpha1ClusterStackList" /> class.
        /// </summary>
        ...
        public KpackBuildV1alpha1ClusterStackList(string apiVersion = default(string), List<KpackBuildV1alpha1ClusterStack> items = default(List<KpackBuildV1alpha1ClusterStack>), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ListMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ListMeta))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for KpackBuildV1alpha1ClusterStackList and cannot be null");
            }
            else
            {
                this.Items = items;
            ...
            if (metadata == null)
            {
                throw new InvalidDataException("metadata is a required property for KpackBuildV1alpha1ClusterStackList and cannot be null");
            }
            else
            {
        ...
        public List<KpackBuildV1alpha1ClusterStack> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KpackBuildV1alpha1ClusterStackList {\n");
        ...
        {
            return this.Equals(input as KpackBuildV1alpha1ClusterStackList);
        }

        /// <summary>
        /// Returns true if KpackBuildV1alpha1ClusterStackList instances are equal
        /// </summary>
        /// <param name="input">Instance of KpackBuildV1alpha1ClusterStackList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KpackBuildV1alpha1ClusterStackList input)
        {
            if (input == null)
                return false;
